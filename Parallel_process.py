...
def main_parallel_largest_batch(Calculation,parameter_list,result_file_name,preset_start_from,verbose=2):
    ...
    Output=Parallel(n_jobs=num_cores,verbose=verbose)(delayed(processInput)(Calculation,parameter_list,i,num_cores,complete_set,preset_start_from) for i in range(num_cores))
    Output_leftover=Parallel(n_jobs=num_cores,verbose=verbose,batch_size=complete_set)(delayed(Calculation)(parameter_list,i) for i in range(total_num))
    result=list()
...
import warnings
def main_parallel(Calculation_i,parameter_list,result_file_name,error_log_file_name,verbose=10):
    num_cores = cpu_count()-1
    try:
        Output=Parallel(n_jobs=num_cores,verbose=verbose)(delayed(Calculation_i)(parameter_i) for parameter_i in parameter_list)
# =============================================================================
#         try:
...
def main_parallel_unsave(Calculation_i,parameter_list,other_args=[],verbose=1,core_save=1):
    num_cores = cpu_count()-core_save
...
if __name__ == '__main__':
    ...
    error_log_file_name='parallel_error.log'
# =============================================================================
#     dir_name=
#     name_dat_main=
...
#     f1.close()
# ============================================================================
    main_parallel(Calculation_i,parameter,result_file_name,error_log_file_name)